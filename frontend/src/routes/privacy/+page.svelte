<div class="mt-12">
	...
	<ul>
		...
		<li>
			<p>
				<strong>Website</strong> refers to anoe.dev, accessible from
				<a href="htts://anoe.dev" rel="external nofollow noopener" target="_blank"
					>htts://anoe.dev</a
				>
			</p>
		</li>
	...
	<ul>
		<li>By email: andrewhoj@gmail.com</li>
	</ul>
</div>

<style>
	h1 {
		@apply pb-4 text-4xl font-bold;
	}

	h2 {
		@apply pb-4 text-3xl font-semibold;
	}
